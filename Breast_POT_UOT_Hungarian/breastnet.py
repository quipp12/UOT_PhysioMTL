...
for i in [0,1]:
    ...
    axes[i].plot(np.log(m), np.log(results_UOT_time_average),label='UOT average', marker ='*',color='dodgerblue')
    axes[i].plot(np.log(m), np.log(results_UOT_time_best),label='UOT best', marker ='*',linestyle='-.',color='skyblue')
    axes[i].plot(np.log(m), np.log(results_UOT_time_worst),label='UOT worst', marker ='*',linestyle=':',color='steelblue')
...
for i in [0,1]:
    ...
    axes[i+2].plot(np.log(m), np.log(results_UOT_time_average),label='UOT average', marker ='*',color='dodgerblue')
    axes[i+2].plot(np.log(m), np.log(results_UOT_time_best),label='UOT best', marker ='*',linestyle='-.',color='skyblue')
    axes[i+2].plot(np.log(m), np.log(results_UOT_time_worst),label='UOT worst', marker ='*',linestyle=':',color='steelblue')
